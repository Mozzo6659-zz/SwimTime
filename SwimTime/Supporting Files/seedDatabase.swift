...
//        myageGrps.append(ageGrp5)
    ...
    func addtheseMembers() {
        ...
        if currentmembers.count == 0 {
            ...
            addmember(memid: 190,memName: "Ashley Goldshmidt",memDOB: "2007-04-14",memGroupID: 0,email: "deanne@intrac.com.au",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 191,memName: "Milla McKellar",memDOB: "2007-04-17",memGroupID: 0,email: "milla07@optusnet.com.au",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 192,memName: "Stephanie Sinapi",memDOB: "2005-06-23",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 193,memName: "Anthony Sinapi",memDOB: "2003-01-28",memGroupID: 0,email: "anthony@rothesayconstructions.com.au",oneKSeconds: 1200,gender: "Male")
            addmember(memid: 194,memName: "Susan Elliott",memDOB: "1974-01-08",memGroupID: 0,email: "susannicoleelliott@Gmail.au",oneKSeconds: 900,gender: "Female")
            addmember(memid: 195,memName: "Pippa Elliott",memDOB: "2012-11-16",memGroupID: 0,email: "",oneKSeconds: 3300,gender: "Female")
            addmember(memid: 196,memName: "Zara Elliott",memDOB: "2009-05-26",memGroupID: 0,email: "",oneKSeconds: 2400,gender: "Female")
            addmember(memid: 197,memName: "Michael Elliott",memDOB: "1980-02-22",memGroupID: 0,email: "",oneKSeconds: 1500,gender: "Male")
            addmember(memid: 198,memName: "Grace Widowson",memDOB: "2005-10-17",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 200,memName: "Saliva Summeraver",memDOB: "2007-06-11",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 201,memName: "Ant Summeraver",memDOB: "1973-05-18",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Male")
            addmember(memid: 202,memName: "Rebecca Simmis",memDOB: "1975-11-17",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 203,memName: "Alexandra Coghlan",memDOB: "2005-04-06",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 204,memName: "Isabella Coghlan",memDOB: "2002-03-29",memGroupID: 0,email: "Isabella.coghlan@ariasolutions.com.au",oneKSeconds: 780,gender: "Female")
            addmember(memid: 206,memName: "Thomas Park",memDOB: "2007-03-24",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Male")
            addmember(memid: 207,memName: "Matthew Park",memDOB: "2009-09-03",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Male")
            addmember(memid: 208,memName: "Madison Calan",memDOB: "2007-07-31",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 209,memName: "William Calan",memDOB: "2010-05-12",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Male")
            addmember(memid: 210,memName: "Victoria Park",memDOB: "1972-12-06",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 211,memName: "Ben Pelican",memDOB: "2007-11-01",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Male")
            addmember(memid: 212,memName: "Rachel Pelikan",memDOB: "1976-02-18",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 213,memName: "Isaac Pelikan",memDOB: "2011-04-07",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Male")
            addmember(memid: 214,memName: "Antonia Sarcasmo",memDOB: "2009-08-09",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 215,memName: "Lucia Sarcasmo",memDOB: "2007-02-15",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 216,memName: "Emersen Stopher",memDOB: "2007-06-25",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 217,memName: "Ella Summeraver",memDOB: "2005-09-21",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 218,memName: "Zali Summeraver",memDOB: "2007-06-11",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 219,memName: "Aria Stopher",memDOB: "2004-10-13",memGroupID: 0,email: "",oneKSeconds: 1200,gender: "Female")
            addmember(memid: 220,memName: "Dan Stopher",memDOB: "1973-05-09",memGroupID: 0,email: "",oneKSeconds: 960,gender: "Male")
            //print("\(lastmemid)")
    ...
    func addmember(memid:Int, memName:String,memDOB:String,memGroupID:Int,email: String,oneKSeconds:Int,
        ...
        let defSwimCub = realm.objects(SwimClub.self).filter("clubID=1").first
